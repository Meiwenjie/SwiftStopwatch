...
SWIFT_CLASS("_TtC14SwiftStopwatch11AppDelegate")
...
SWIFT_CLASS("_TtC14SwiftStopwatch14ViewController")
@interface ViewController : UIViewController
@property (nonatomic) double Counter;
@property (nonatomic, strong) NSTimer * __nonnull Timer;
@property (nonatomic) BOOL Isplaying;
@property (nonatomic, strong) UILabel * __nonnull timeLabel;
- (UIStatusBarStyle)preferredStatusBarStyle;
- (void)viewDidLoad;
- (void)resetClick:(UIButton * __nonnull)sender;
- (void)leftclick:(UIButton * __nonnull)sender;
- (void)rightclick:(UIButton * __nonnull)sender;
- (void)update;
